...
if(isset($_REQUEST['email']) && $_REQUEST['email']!="")
{
	...
	$sqlSelect  = mysql_query("select f_name, l_name, email, active, verification_key from ba_tbl_user where email = '$email'");
	...
	{	
		...
		$message_body = '
			...
			<title> Buyers Picks - Password Reset </title>
			                	...
			                	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="responsive-table">
			                      ...
			                      <tr>
			                        <td style="font-family:Helvetica, Arial, sans-serif; color:#415161; font-size:15px; padding: 15px 0 0px 40px; ">
			                        	We received a request to <span style="font-weight:bold;">change the password</span> of your BuyersPicks App account.
			                        </td>
			                      </tr>
			                      <tr>
			                        <td style="font-family:Helvetica, Arial, sans-serif; color:#415161; font-size:15px; padding: 15px 0 0px 40px;">
			                        	If you have not sent this request or it has been sent to us by mistake, please ignore the mail.
			                        </td>
			                      </tr>
			                      <tr>
			                        <td style="font-family:Helvetica, Arial, sans-serif; color:#415161; font-size:15px; padding: 15px 0 0px 40px;">
			                        	To continue the <span style="font-weight:bold;">password reset</span> process, <span style="color:#fd0000;">click on this link:</span>
			                        </td>
			                      </tr>
			                      <tr>
			                        <td style="font-family:Helvetica, Arial, sans-serif; color:#424242; font-size:15px; padding: 15px 0 5px 40px;">
			                        	<a href="http://skibuyerspick.appspot.com/reset/?id='.base64_encode($email).'&r='.$verification_key.'" style="color:red; text-decoration:none;"><img src="http://www.buyerspicks.com/images/resetpassword.png" border="0" /></a>
			                        </td>
			                      </tr>
                      
			                      <tr>
			                        <td style="font-family:Helvetica, Arial, sans-serif; color:#415161; font-size:15px; padding: 15px 0 5px 40px; line-height:20px;">
			                        	On clicking the link, you will be redirected to a new page and asked to <span style="font-weight:bold;">change your password.</span> If you are still facing a problem, please get in touch with us at <a href="#" style="color:#415161;">support@buyerpicks.com</a>
		...
		try {
			...
			$message->send();
			$sqlUpdate = mysql_query("update ba_tbl_user set verification_key = '$verification_key' where email = '$email'");
			echo '[{"response":"Password Reset link sent to Your email."}]';
		...
		{
			echo '[{"response":"User not verified!!"}]';
		}
	}
	else
	{
