...
if(isset($_POST['push_no']) && isset($_POST['txt_message']) ){
	...
	print "DEVICE NO : " . $deviceToken . "<br>";
...
<?php
$sql_device	= "Select * from tbl_user_push";
...
<div id="content-outer">
	...
	<div id="content">
		...
		<table border="0" width="100%" cellpadding="0" cellspacing="0" id="content-table">
			<tr>
				<th rowspan="3" class="sized"><img src="http://apps.micrositeads.com/yjhd/backend/images/shared/side_shadowleft.jpg" width="20" height="300" alt="" /></th>
				<th class="topleft"></th>
				<td id="tbl-border-top">&nbsp;</td>
				<th class="topright"></th>
				<th rowspan="3" class="sized"><img src="http://apps.micrositeads.com/yjhd/backend/images/shared/side_shadowright.jpg" width="20" height="300" alt="" /></th>
			</tr>
			<tr>
				...
				<!--  start content-table-inner -->		
					<div id="content-table-inner">
						<form id="frm_pushnotifications" name="" method="post" action="http://apps.micrositeads.com/yjhd/backend/push_to_iphone/iphone_push_to_many.php">
							<table border="0" width="100%" cellpadding="0" cellspacing="0">
                                    	...
                                    	<tr>
											...
											<tr>
												...
												while ($row = mysql_fetch_array($res_device)) {
													...
													print "DEVICE NO : " . $deviceno . "<br>";
													$sql_usrnm	= "Select user_name from tbl_user_detail WHERE device_no='$deviceno'";
													print $sql_usrnm . "<br>";
													$res_usrnm	= mysql_query($sql_usrnm);
													$row_usrnm	= mysql_fetch_array($res_usrnm);
													$user_name	= $row_usrnm['user_name'];
													print "I : " . $i . "&nbsp;&nbsp;&nbsp; USER NAME : "  . $user_name . "<br><br>";
													$i++;
												}
												exit;
												?>
                                                	<select style="width:150px;" name="push_no" id="push_no" onChange="setTextVal(this.value)">
														...
														?>
                                                        <option value="<?php echo $row["device_token"] ?>"><?php echo $user_name;?></option>
                                                        <?php } ?>
                                                    </select>
                                                </td>
												<td></td>
                                            ...
                                            <tr>
												...
												<td>
													...
													<input type="text" name="regId" id="regId" class="txt_gcmid" value="" readonly="readonly" />
                                                </td>
												<td></td>
											</tr>
											<tr>
								...
								<tr>
									<td><img src="http://apps.micrositeads.com/yjhd/backend/images/shared/blank.gif" width="695" height="1" alt="" /></td>
									<td></td>
								</tr>
							</table>
						</form>
